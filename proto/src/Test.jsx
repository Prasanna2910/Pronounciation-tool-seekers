...
useEffect(()=>{
    ...
    axios.get(`http://localhost:5000/test/${id}/${level}`).then((res)=>{
        // endpoint returns the test object
...
const handleSubmit = async ()=>{
    ...
    try{
        setSubmitting(true)
        await axios.post(`http://localhost:5000/test/submit/${testData._id || id}`, { result, user_id: user._id })
