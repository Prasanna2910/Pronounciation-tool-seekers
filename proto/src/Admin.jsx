...
function Admin() {
    ...
    useEffect(() => {
        axios.get("http://localhost:5000/test/", { headers: { "Authorization": localStorage.getItem("token") } }).then((res) => {
    ...
    const handleSubmit = async (ev) => {
        ...
        try {
            await axios.post('http://localhost:5000/test/', testObj, { headers: { "Authorization": localStorage.getItem("token") } })
        } catch (err) {
